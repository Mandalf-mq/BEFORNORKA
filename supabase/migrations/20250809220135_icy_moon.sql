/*
  # Correction de la table club_settings

  1. Problème identifié
    - La table club_settings existe mais avec une structure incorrecte
    - Les colonnes attendues n'existent pas
  ...
  3. Sécurité
    ...
    - Fonction RPC pour vérifier/créer la table
*/

-- ========================================
-- ÉTAPE 1: SUPPRIMER LA TABLE EXISTANTE SI ELLE A UNE MAUVAISE STRUCTURE
-- ========================================

-- Supprimer la table club_settings si elle existe avec une mauvaise structure
...
-- Créer la table club_settings avec TOUS les champs nécessaires
...
DO $$
BEGIN
  RAISE NOTICE '✅ TABLE CLUB_SETTINGS CORRIGÉE ET CRÉÉE !';
  RAISE NOTICE '';
  RAISE NOTICE '🗄️ Table recréée :';
