/*
  # Création de la table club_settings pour les paramètres généraux
  ...
  2. Fonction RPC
    - create_club_settings_table() pour créer la table si nécessaire
...
-- ========================================
-- ÉTAPE 3: FONCTION RPC POUR CRÉER LA TABLE
-- ========================================
