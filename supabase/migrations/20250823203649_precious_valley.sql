/*
  # Fonctions d'import CSV avec création de comptes

  1. Nouvelles colonnes
    - users.temp_password : Mot de passe temporaire
    - users.must_change_password : Forcer changement à la connexion

  2. Nouvelles fonctions
    - import_members_with_accounts : Import CSV complet
    - generate_temp_password : Génération mots de passe
    - create_member_account_with_password : Création compte individuel
...
BEGIN
  ...
  -- Calculer la cotisation selon la catégorie
...
BEGIN
  ...
  LOOP
    BEGIN
      ...
      -- Créer le compte avec la fonction existante
