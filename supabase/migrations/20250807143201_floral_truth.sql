...
BEGIN
  ...
  RAISE NOTICE '  1. Copiez ce code SQL';
  RAISE NOTICE '  2. Allez dans Supabase Dashboard → SQL Editor';
  RAISE NOTICE '  3. Collez et exécutez (bouton Run)';
  RAISE NOTICE '  4. Rafraîchissez votre application (F5)';
  RAISE NOTICE '  5. La section Paramètres devrait être accessible !';
END $$;