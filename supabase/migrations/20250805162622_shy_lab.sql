/*
  # Correction de l'erreur de fonction validate_document

  1. Problème identifié
    - La fonction validate_document existe déjà avec un type de retour différent
  ...
  2. Solutions
    ...
    - Recréer avec le bon type de retour (jsonb)
    - Corriger les contraintes de statuts
    
  3. Workflow complet
    - Nouveaux statuts : pending → validated → documents_pending → documents_validated → season_validated
...
DROP FUNCTION IF EXISTS validate_document(uuid, text, text, text);

-- ========================================
-- ÉTAPE 2: MISE À JOUR DES CONTRAINTES DE STATUTS
-- ========================================
...
-- ========================================
-- ÉTAPE 3: FONCTION POUR DÉTERMINER LES DOCUMENTS OBLIGATOIRES
-- ========================================
...
-- ========================================
-- ÉTAPE 4: NOUVELLE FONCTION VALIDATE_DOCUMENT AVEC RETOUR JSONB
-- ========================================

-- Créer la nouvelle fonction validate_document avec le bon type de retour
...
-- ========================================
-- ÉTAPE 5: TRIGGERS POUR TRANSITIONS AUTOMATIQUES
-- ========================================
...
-- ========================================
-- ÉTAPE 6: FONCTION DE CHANGEMENT DE SAISON
-- ========================================
...
-- ========================================
-- ÉTAPE 9: FONCTION POUR OBTENIR LE STATUT COMPLET D'UN MEMBRE
-- ========================================
...
-- ========================================
-- ÉTAPE 10: FONCTION POUR OBTENIR LES MEMBRES PAR CATÉGORIE POUR WHATSAPP
-- ========================================
...
-- ========================================
-- ÉTAPE 11: FONCTION DE DIAGNOSTIC DU WORKFLOW
-- ========================================
...
-- ========================================
-- ÉTAPE 12: INDEX POUR LES PERFORMANCES
-- ========================================
...
DO $$
BEGIN
  RAISE NOTICE '✅ FONCTION VALIDATE_DOCUMENT CORRIGÉE ET WORKFLOW IMPLÉMENTÉ !';
  RAISE NOTICE '';
  ...
  RAISE NOTICE '  - validate_document(id, action, reason) → RETOURNE jsonb';
