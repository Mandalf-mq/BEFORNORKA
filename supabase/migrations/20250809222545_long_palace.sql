/*
  # Correction de la table club_settings pour la persistance des paramètres

  1. Problème identifié
    - Table club_settings existe mais avec une structure incorrecte
    - Colonnes attendues manquantes (club_name, club_description, etc.)
    
  2. Solution
    - Supprimer la table existante
    - Recréer avec la structure correcte
    - Insérer les valeurs par défaut
    - Créer la fonction RPC nécessaire
