/*
  ...
  1. Problèmes identifiés
    - Fonction validate_document existe avec un type de retour différent
    - Vue member_documents_complete n'existe pas
    - Tables manquantes pour le bon fonctionnement
...
DO $$
BEGIN
  RAISE NOTICE 'ERREUR DE FONCTION SQL CORRIGEE !';
  RAISE NOTICE '';
