...
-- ========================================
-- ÉTAPE 7: SUPPRIMER LES COLONNES MEMBERSHIP_FEE DES CATEGORIES
-- ========================================

-- Supprimer la colonne membership_fee de la table categories pour dissocier complètement
-- Note: On garde la colonne pour l'instant pour éviter de casser l'existant
-- Elle peut être supprimée plus tard si nécessaire

-- ========================================
-- ÉTAPE 8: MISE À JOUR DES CONTRAINTES
-- ========================================
